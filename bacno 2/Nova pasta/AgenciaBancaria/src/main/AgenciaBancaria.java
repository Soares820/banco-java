...
public class AgenciaBancaria {
    ...
    public static void criarConta() {
        ...
        String nome = input.nextLine(); // Usar nextLine() para ler a linha completa
        System.out.println("\nNome: ");
        
        
        String cpf = input.nextLine(); // Usar nextLine() para evitar pular entradas
        System.out.println("\nCPF: ");
       ...
       //  System.out.println("Renda Anual: ");
        ...
        // Consumir a nova linha que ficou pendente após nextDouble
        input.nextLine();
